...
def create_report(data):
    Write_file('adminFinder_output.txt', data)
...
'memberadmin/','administratorlogin/','adm/','admin/account.php','admin/index.php','admin/login.php','login.php','admin/admin.php','admin/account.php',
...
'adm/index.php','adm.php','affiliate.php','adm_auth.php','memberadmin.php','administratorlogin.php']  
	...
	try:
		print ("Checking if website is online " + url.replace("http://","") )
		conn = httplib.HTTPConnection(url)
		conn.connect()
		print "Website is online."
	except (httplib.HTTPResponse, socket.error) as Exit:
		create_report("Error occured, Website offline or invalid URL")
	   	exit()
	print("Scanning " + url + "...\n")
	for admin in regular:
		...
		if response.status == 200:
			...
			create_report("%s %s" % (" " + host, "Possible admin page (302 - Redirect)"))
		else:
			create_report("%s %s %s" % (" " + host, " Interesting response:", response.status))
		connection.close()
   	print("\nScan Completed \n")
